...
- ### 1. 打開 `shell` 輸入指令下載資料集
  ...
  +  Windows 用戶在左下角按右鍵 ![](img/Windows_cmd.png)
...
if(.Platform$OS.type != "unix"){
  url <- "https://github.com/whizzalan/RReportCrashCourse/raw/gh-pages/data/datasets_big5.rda"
  download.file(url,paste0(getwd(),"/data/datasets_big5.rda"))
...
```{r,echo=FALSE}
#講師自己背後讀
# save(Cl_info,quartet,creditData,credit,file = "data/datasets.rda")
# save(Cl_info,quartet,creditData,credit,file = "data/datasets_big5.rda")
if(.Platform$OS.type != "unix") load("data/datasets_big5.rda") else load("data/datasets.rda")
ls()
```
...
### [HINT 可以點點看](https://suensummit.github.io/RCourseBankSinoPac/week2handouts.html)
